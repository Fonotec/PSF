...
class HeaderFrame(tk.Frame):
    def __init__(self, master):
        ...
        self.Label_Status = tk.Label(
            self, text="Status IDLE", font=("Courier New", 22), padx=2, pady=8
        )
        self.Label_Observate_Status = tk.Label(
            self, text="Pulsar observing mode", font=("Courier New", 22), padx=8, pady=8
        )
        self.Label_Target_Name = tk.Label(
            self, text="No object in view", font=("Courier New", 22), padx=2, pady=8
        )
...
class MenuFrame(tk.Frame):
    def __init__(self, master):
        ...
        self.MenuAButton = tk.Button(
            self, text="MAIN", command=self.A_button, width=14, padx=12, pady=10
        )
        self.MenuBButton = tk.Button(
            self, text="PLUS", command=self.B_button, width=14, padx=12, pady=10
        )
        self.MenuCButton = tk.Button(
            self, text="SAVED DATA", command=self.C_button, width=14, padx=12, pady=10
        )
        self.MenuDButton = tk.Button(
            self, text="FRANS", command=self.D_button, width=14, padx=12, pady=10
        )
...
class MenuAFrame(tk.Frame):
    def __init__(self, master):
        ...
        self.FilenameLabel = tk.Label(
            self, text="Output name (.fits)", font=("Courier New", 14), padx=30, pady=20
        )
        self.FilenameEntry = tk.Entry(self, font=("Courier New", 14), width=18)

        self.ObjectnameLabel = tk.Label(
            self, text="Object name", font=("Courier New", 14), padx=30, pady=20
        )
        self.ObjectnameEntry = tk.Entry(self, font=("Courier New", 14), width=18)

        self.ObservationTimeLabel = tk.Label(
            self,
            text="Observation time (s)",
            font=("Courier New", 14),
            padx=30,
            pady=20,
        )
        ...
        self.CentralFrequencyLabel = tk.Label(
            self, text="Mixing freq. (MHz)", font=("Courier New", 14), padx=30, pady=20
        )
...
class MenuBFrame(tk.Frame):
    def __init__(self, master):
        ...
        self.PeriodLabel = tk.Label(
            self, text="Period (s)", font=("Courier New", 14), padx=30, pady=20
        )
        self.PeriodEntry = tk.Entry(self, font=("Courier New", 14))

        self.DispersionMeasureLabel = tk.Label(
            self, text="Dispersion Measure", font=("Courier New", 14), padx=30, pady=20
        )
        self.DispersionMeasureEntry = tk.Entry(self, font=("Courier New", 14))

        self.BinsAmountLabel = tk.Label(
            self, text="Number of bins", font=("Courier New", 14), padx=30, pady=20
        )
        ...
        self.ResetGraphButton = tk.Button(
            self,
            text="Reset Plot",
            font=("Courier New", 20),
            command=self.RunMain,
        ...
        self.StopGraphButton = tk.Button(
            self,
            text="Stop Plot",
            font=("Courier New", 20),
            command=self.RunMain,
    ...
    def getEntries(self):
        ...
        if len(MissingVariables):
            ...
            self.popUpLabel = tk.Label(
                popUp,
                text="Please fill in empty entry fields",
                font=("Courier New", 14),
                padx=5,
            )
            self.popUpOK = tk.Button(
                popUp, text="Okay", font=("Courier New", 14), width=12, height=2
            )
            self.popupDIFM = tk.Button(
                popUp,
                text="Do it for me!",
                font=("Courier New", 14),
                width=12,
...
class MenuCFrame(tk.Frame):
    ...
    def build(self):
        ...
        self.CentralFrequencyLabel = tk.Label(
            self, text="Central freq. (MHz)", font=("Courier New", 14), padx=30, pady=20
        )
        self.CentralFrequencyEntry = tk.Entry(self, font=("Courier New", 14))
...
class MenuDFrame(tk.Frame):
    def __init__(self, master):
        ...
        self.GOBUTTON = tk.Button(
            self, image=self.GoImage, border=0, command=self.switchon
        )
    ...
    def switchon(self):
        ...
        self.STOPBUTTON = tk.Button(
            self, image=self.StopImage, border=0, command=self.switchoff
        )
...
class PlotFrame(tk.Frame):
    def __init__(self, master):
        ...
        self.dpi = 100
        self.f = Figure(
            figsize=(self.fwidth / self.dpi, self.fheight / self.dpi),
            dpi=self.dpi,
            facecolor=(1, 1, 1, 0),
        )
        ...
        self.yDataM = np.sin(self.xData) * np.sin(self.xData * 0.5 + 0.4)
    ...
    def animate2(self, reScaled):
        ...
        if scale:
            ...
            colorArray = np.array(
                [(1, 0, 0, a) for a in np.roll(waveShape, currentIdx)]
            )
...
class FillerFrame(tk.Frame):
    def __init__(self, master):
        ...
        self.FPSValueLabel = tk.Label(
            self, text="{}".format(int(0)), font=("Courier New", 14)
        )
    ...
    def updateFPS(self, FPS, current_time):
        if current_time - self.prevtime > 0.3:
            ...
            self.i += 1
            self.FPSValueLabel = tk.Label(
                self, text="{}".format(int(FPS)), font=("Courier New", 14)
            )
